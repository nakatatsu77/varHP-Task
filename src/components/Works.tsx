                ...
                <div style={{ opacity: 1 }}>
                  <div className="xl:flex">
                    ...
                    <div className="-ml-3 mr-[calc(50%-50vw)] mt-[44px] xl:mt-0">
                      <div className="swiper swiper-initialized swiper-horizontal swiper-pointer-events w-[calc(342px*3)] md:w-[calc(399px*3+8px*2)] swiper-backface-hidden">
                        <div
                        ...
                        >
                          <SwiperSlide>
                            <div
                              className="swiper-slide swiper-slide-duplicate swiperHeightAuto relative w-[328px] rounded-[32px] p-3 md:w-[376px]"
                              data-swiper-slide-index="0"
                              style={{ width: "399px", marginRight: "8px" }}
                            >
                          ...
                          <SwiperSlide>
                            {" "}
                            <div
                              className="swiper-slide swiper-slide-duplicate swiperHeightAuto relative w-[328px] rounded-[32px] p-3 md:w-[376px] swiper-slide-duplicate-active"
